...
\previousversion[http://www.ivoa.net/Documents/REC/VOE/VOEvent-20061101.html]{VOEvent 1.11}
...
\noindent {\bf3.3.1.3} {\tt unit}\label{sec:3.3.1.3} --- The unit for interpreting {\tt value}. See \S4.3 of [\hyperref[bib21]{21}]
%\citep{std:VOTABLE}
which relies on [\hyperref[bib25]{25}]. 

\noindent {\bf3.3.1.4} {\tt ucd}\label{sec:3.3.1.4} --- A UCD [\hyperref[bib18]{18}]
%\citep{std:UCD} 
...
\noindent {\bf3.3.1.6} {\tt utype}\label{sec:3.3.1.6} --- A {\tt utype} [\hyperref[bib32]{32}] defines this {\tt <Param>} as part of a larger data structure, such as one of the IVOA standard data models. 
...
\noindent {\bf3.3.3.4} {\tt unit}\label{sec:3.3.3.4} --- The unit for interpreting the values as given in the {\tt <TD>} table cells See \S4.3 of [\hyperref[bib21]{21}]
%\citep{std:VOTABLE}
which relies on [\hyperref[bib25]{25}]. 

\noindent {\bf3.3.3.5} {\tt ucd}\label{sec:3.3.3.5} --- A UCD [\hyperref[bib18]{18}]
%\citep{std:UCD} 
...
\noindent {\bf3.3.3.7} {\tt utype}\label{sec:3.3.3.7} --- A utype [\hyperref[bib31]{31}] defines this {\tt <Param>} as part of a larger data structure, such as one of the IVOA standard data models. 
...
this capability element using \xmlel{vr:interface} elements, which must
be of type \xmlel{voe:StreamEndpoint}.  Each interface must have
...
comes with this
specification\footnote{\auxiliaryurl{resrec-sample.vor}}.
...
%\footnotesize\verbatiminput{VOEvent-v2.0.xsd}
{\footnotesize
\begin{verbatim}
<?xml version="1.0" encoding="UTF-8"?>
