...
Only those elements required to convey the event being described need to be
...
\lstinputlisting[language=XML]{voevent-ex1.xml}
...
\xmlel{Why} section.
\lstinputlisting[language=XML]{voevent-ex2.xml}
